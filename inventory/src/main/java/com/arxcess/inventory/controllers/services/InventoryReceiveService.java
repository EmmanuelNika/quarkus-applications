...
//        Uni<List<InventoryActivity>> activities = Uni.createFrom()
//                .item(new ArrayList<>());
//
//        request.itemRequests.forEach(receiveItemRequest -> {
//            itemRepository.findById(receiveItemRequest.itemId).onItem().ifNotNull().transform(inventoryItem -> {
//
...
//
//                    activities =  Uni.createFrom()
//                            .item( Panache.withTransaction(inventoryActivity::persist)
//                           .replaceWith(inventoryActivity)
//                           .onItem()
//                           .ifNotNull()
//                           .transform(activities::add));
//
...
//                        inventoryActivity.inventoryItem = inventoryItem;
//
//                        activities.map(transactionActivities -> transactionActivities.add(Panache.withTransaction(inventoryActivity::persist).replaceWith(inventoryActivity)));
//
//                    });
//
//                } else {
...
//                    inventoryActivity.inventoryItem = inventoryItem;
//
//                    Panache.withTransaction(inventoryActivity::persist);
//                }
//
//                return Response.created(URI.create("/receives")).status(Status.CREATED).entity(activities).build();
//
//            }).onItem().ifNull().fail().onFailure().recoverWithItem(CustomErrorHandler.notFound(NOT_FOUND));
//        });
//
//        return Uni.createFrom()
//                  .item(Response.created(URI.create("/receives"))
